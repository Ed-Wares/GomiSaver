# GomiSaver
Very simple Windows ScreenSaver that draws a lightning bolt across the screen.  Originally written in 2002 for a friend.

### Demo

Here is a quick look at the application:

![Demo](https://github.com/Ed-Wares/GomiSaver/blob/main/DemoGomiSaver.gif?raw=true)

## Usage
To start run GomiSaver.exe

To exit the GomiSaver application move the mouse or press any key.
...
Build binaries by running the build.bat script or from VsCode by running the Build and Debug Active File Task.
